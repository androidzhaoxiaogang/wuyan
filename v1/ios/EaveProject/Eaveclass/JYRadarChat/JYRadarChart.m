...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		_backgroundLineColor = [UIColor clearColor];//-----
		...
		//self.attributes = @[@"you", @"should", @"set", @"these", @"data", @"titles,",@"this", @"is", @"just", @"a", @"placeholder"];
...
- (void)setDataSeries:(NSArray *)dataSeries {
	...
	if (self.legendView.colors.count < _dataSeries.count)
    {
        ...
        {
			//UIColor *color = [UIColor colorWithHue:1.0 * (i * COLOR_HUE_STEP % MAX_NUM_OF_COLOR) / MAX_NUM_OF_COLOR saturation:1 brightness:1 alpha:self.colorOpacity];
            
            UIColor *color = [UIColor colorWithRed:110 / 255.0 green:113 / 255.0 blue:120 /255.0 alpha:1.0];
