...
- (UIImage *)lowerHandleImageNormal
{
    if(_lowerHandleImageNormal==nil)
    {
        //UIImage* image = [UIImage imageNamed:@"slider-default-handle"];
         UIImage* image = [UIImage imageNamed:@"wc_userSec_slider"];
...
- (void) addSubviews
{
    ...
    self.LeftLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, 10, 25, 20)];
    self.LeftLabel.text = @"100";
    
    self.LeftLabel.font = [UIFont systemFontOfSize:10];
    self.LeftLabel.textColor = [UIColor colorWithRed:110 / 255.0 green:113 / 255.0 blue:120 /255.0 alpha:1.0];
    [self addSubview:self.LeftLabel];
    
    self.RightLabel = [[UILabel alloc]initWithFrame:CGRectMake(176, 10, 25, 20)];
    self.RightLabel.text = @"8000";
    self.RightLabel.font = [UIFont systemFontOfSize:10];
    self.RightLabel.textColor = [UIColor colorWithRed:110 / 255.0 green:113 / 255.0 blue:120 /255.0 alpha:1.0];
    [self addSubview:self.RightLabel];
    
    IOS.minPrice = self.LeftLabel.text;
    IOS.maxPrice = self.RightLabel.text;
...
-(void)layoutSubviews
{
    ...
    self.trackBackground.frame = CGRectMake(0, 38, 200, 1);
    self.track.frame = CGRectMake(0, 38, 0, 1);
...
-(BOOL)continueTrackingWithTouch:(UITouch *)touch withEvent:(UIEvent *)event
{
    ...
    self.LeftLabel.frame = CGRectMake(175*self.lowerValue, 10, 25, 20);
    self.RightLabel.frame = CGRectMake(self.upperValue*175, 10, 25, 20);
    
    self.LeftLabel.text = [NSString stringWithFormat:@"%0.f",(int)8000*self.lowerValue+100];
    
    IOS.minPrice = self.LeftLabel.text;
    
    self.LeftLabel.textColor = [UIColor blackColor];
    self.RightLabel.text = [NSString stringWithFormat:@"%0.f",(int)8000*self.upperValue];
