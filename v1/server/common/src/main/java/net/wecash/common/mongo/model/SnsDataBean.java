...
public class SnsDataBean {
	...
	private List<String> favoriteSubjectTerm;
	...
	public SnsDataBean(String uid, Long userId, String token, Integer type, String name,
			List<String> tags, List<String> timelineSubjectTerm, List<String> favoriteSubjectTerm,
		...
		this.favoriteSubjectTerm = favoriteSubjectTerm;
		this.bilateralFriends = bilateralFriends;
		this.profileImage = profileImage;
	}
	
	public List<String> getFavoriteSubjectTerm() {
		return favoriteSubjectTerm;
	}

	public void setFavoriteSubjectTerm(List<String> favoriteSubjectTerm) {
		this.favoriteSubjectTerm = favoriteSubjectTerm;
	}
